...
Listado.prototype.buscarRestaurante = function(id) {
    ...
    this.restaurantes.find(function(id) {
        return id === id;
      });
...
Listado.prototype.eliminarRepetidos = function(array) {
    var array2 = array.filter(function(elem, index, self) {
...
Listado.prototype.obtenerCiudades = function() {
    ...
    var c = this.restaurantes.map(restaurant => restaurant.ubicacion);





    return this.eliminarRepetidos(c);
}
...
Listado.prototype.obtenerRubros = function() {
    ...
    var r = this.restaurantes.map(restaurant => restaurant.rubro);

    return this.eliminarRepetidos(r);
}
...
Listado.prototype.obtenerHorarios = function() {
    ...
    var arregloH = this.restaurantes.map(restaurant => restaurant.horarios);
    ...
    return this.eliminarRepetidos(h);
}
